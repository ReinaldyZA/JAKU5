...
==========================================================================
Membangun SEMUA data tampilan dashboard dari sumber TUNGGAL: Data_ISPU.csv
(dataset asli skripsi) + model XGBoost terlatih (models/*.pkl yang berasal
dari notebook CRISP-DM). Output menggantikan data dummy lama.
...
Jalankan ulang setiap kali Data_ISPU.csv diperbarui:
...
FITUR = ["pm_sepuluh", "pm_duakomalima", "sulfur_dioksida",
         "karbon_monoksida", "ozon", "nitrogen_dioksida"]
KAT_VALID = ["BAIK", "SEDANG", "TIDAK SEHAT"]

# Normalisasi nama stasiun (persis train_model.py + varian Kebon Jeruk)
STASIUN_MAP = {
...
# ───────────────────────── LOAD & CLEAN ─────────────────────────
def load_clean():
    df = pd.read_csv(BASE / "Data_ISPU.csv", sep=";")
